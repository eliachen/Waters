...
<html>
    <head>
        ...
        <title>气象信息监视图</title>
         ...
         <link type="text/css" href="./resources/WaterResource-dals/Map/InfMapMeteorology/ml.css" rel="stylesheet" />
         <script type="text/javascript">
          /*  var cig={
            ...
            seajs.use(["./resources/WaterResource-dals/Map/InfMapMeteorology/do.js",
                       "./resources/WaterResource-dals/Map/demodata.js"],function(mr,d){
                       mr.initial(d);
            });
        </script>
      ...
      <div id="layoutcontent" style="width:100%;height:100%;margin:0; padding:0;">
        ...
        <div id="rightcontent"  position="right" title="信息查看">
            <div id="navaccordion" class="liger-accordion">
                <div id="sector1" title=" 分区1信息" >
                    <ul id="treeInfsector1"></ul>
                </div>
                
                <div id="sector2" title="分区2信息">
                    <ul id="treeInfsector2"></ul>
                </div>
            </div>
        </div>
    </div>
