        ...
        <script type="text/javascript">
                ...
                require.config({
                    paths: {
                        ...
                        'sw-krquery':"./resources/WaterResource-dals/ChartQuerys/sw-krQuery/sw-krQuery",
                        'sw-krdata':"./resources/WaterResource-dals/ChartQuerys/sw-krQuery/sw-krdata"
                    }
                    });
