        ...
        <script type="text/javascript">
                ...
                require.config({
                    paths: {
                        ...
                        'waterquery':"./resources/WaterResource-dals/ChartQuerys/waterQuery/waterQuery",
                        'waterdata':"./resources/WaterResource-dals/ChartQuerys/waterQuery/waterdata"
                    }
                    });
